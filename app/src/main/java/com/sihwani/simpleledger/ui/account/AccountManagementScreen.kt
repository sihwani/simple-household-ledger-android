...
private fun AccountCard(
    ...
    Card(
        ...
        Column(
            ...
            Text(
                text = "${item.scheduledMonthLabel} 예정 수입 +${MoneyFormatter.formatWon(item.scheduledIncome)}",
                style = MaterialTheme.typography.bodySmall,
                fontWeight = FontWeight.Bold,
            ...
            Text(
                text = "${item.scheduledMonthLabel} 예정 지출 -${MoneyFormatter.formatWon(item.scheduledExpense)}",
                style = MaterialTheme.typography.bodySmall,
                fontWeight = FontWeight.Bold,
            ...
            Text(
                text = "${item.scheduledMonthLabel} 말 예상 잔액 ${MoneyFormatter.formatWon(item.expectedMonthEndBalance)}",
                style = MaterialTheme.typography.bodySmall,
                fontWeight = FontWeight.ExtraBold,
                color = Color(0xFF18181B),
                maxLines = 1,
