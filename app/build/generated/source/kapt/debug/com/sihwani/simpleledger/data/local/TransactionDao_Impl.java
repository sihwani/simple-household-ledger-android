...
public final class TransactionDao_Impl implements TransactionDao {
  ...
  public TransactionDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTransactionEntity = new EntityInsertionAdapter<TransactionEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `transactions` (`id`,`type`,`title`,`amount`,`category`,`date`,`memo`,`receiptImagePath`,`createdAt`,`updatedAt`) VALUES (?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getMemo() == null) {
          ...
          statement.bindString(7, entity.getMemo());
        }
        if (entity.getReceiptImagePath() == null) {
          statement.bindNull(8);
        } else {
          statement.bindString(8, entity.getReceiptImagePath());
        }
    ...
    this.__upsertionAdapterOfTransactionEntity = new EntityUpsertionAdapter<TransactionEntity>(new EntityInsertionAdapter<TransactionEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "INSERT INTO `transactions` (`id`,`type`,`title`,`amount`,`category`,`date`,`memo`,`receiptImagePath`,`createdAt`,`updatedAt`) VALUES (?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE `transactions` SET `id` = ?,`type` = ?,`title` = ?,`amount` = ?,`category` = ?,`date` = ?,`memo` = ?,`receiptImagePath` = ?,`createdAt` = ?,`updatedAt` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Object upsertAll(final List<TransactionEntity> transactions,
  ...
  public Object upsert(final TransactionEntity transaction,
    ...
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        __db.beginTransaction();
        try {
          __upsertionAdapterOfTransactionEntity.upsert(transaction);
          __db.setTransactionSuccessful();
          return Unit.INSTANCE;
        } finally {
          __db.endTransaction();
      ...
      public List<TransactionEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new TransactionEntity(_tmpId,_tmpType,_tmpTitle,_tmpAmount,_tmpCategory,_tmpDate,_tmpMemo,_tmpReceiptImagePath,_tmpCreatedAt,_tmpUpdatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<List<TransactionEntity>> observeByMonth(final String monthPrefix) {
    final String _sql = "\n"
            + "        SELECT * FROM transactions\n"
            + "        WHERE date LIKE ? || '%'\n"
            + "        ORDER BY date DESC, createdAt DESC\n"
  ...
  @Override
  public Flow<TransactionEntity> observeById(final String id) {
      ...
      public TransactionEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new TransactionEntity(_tmpId,_tmpType,_tmpTitle,_tmpAmount,_tmpCategory,_tmpDate,_tmpMemo,_tmpReceiptImagePath,_tmpCreatedAt,_tmpUpdatedAt);
          } else {
            _result = null;
          }
          return _result;
